...
Netlist(Add,GND,C150-2)
Netlist(Add,GND,C151-2)
Netlist(Add,N15V,C152-2)
Netlist(Add,N15V,CONN163-1)
Netlist(Add,N15V,CONN163-2)
Netlist(Add,N15V,U101-4)
Netlist(Add,N15V,C151-1)
Netlist(Sort)
Netlist(Thaw)
ElementList(Start)
ElementList(Need,"R103","0805","67.3K")
...
ElementList(Need,"R101","0805","475")
...
ElementList(Need,"C102","KEMET_SMR5xxxxxxJ06xxx.x.subc.lht","470nF")
...
ElementList(Need,"C101","KEMET_SMR5xxxxxxJ06xxx.x.subc.lht","470nF")
...
ElementList(Need,"R100","0805","67.3K")
