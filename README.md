...
Finally some readers might notice that I used 22uF aluminum polymer capacitors instead of tantalum or ceramic. I stopped using tantalum and most ceramic because of the conditions around <a href="https://www.wbur.org/npr/1152893248/red-cobalt-congo-drc-mining-siddharth-kara">mining used in their production.</a> Ceramic capacitors were also avoided in many locations because of their microphonic effects <a href="https://product.tdk.com/system/files/contents/faq/capacitors-0031/singing_capacitors_piezoelectric_effect.pdf">caused by piezoelectric effects.</a>
...
* 2022 - Added extra footprint for alternative package size C66 to replace C61
...
|:---------------                               |:---------------
|ALT2: output.sch C48 is not to be stuffed      |ALT3: notchfilter.sch C152 & C153 are also not stuffed

## Changelog

### Post EPL fork

2022 - Revised output.sch to add extra footprint for 2nd package size of C66 to replace C61 if unavailable.
