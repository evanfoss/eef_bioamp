...
Netlist(Add,unnamed_net4,U40-1)
Netlist(Add,unnamed_net4,R41-1)
...
Netlist(Add,unnamed_net2,TP5-1)
Netlist(Add,unnamed_net2,CONN40-1)
Netlist(Add,unnamed_net2,C41-2)
Netlist(Add,NVIN:1,U40-3)
Netlist(Add,NVIN:1,R43-2)
Netlist(Add,NVIN:1,C41-1)
Netlist(Add,unnamed_net1,CONN40-2)
Netlist(Add,unnamed_net1,TP4-1)
