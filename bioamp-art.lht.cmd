Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net10,CONN42-1)
Netlist(Add,unnamed_net10,U?-?)
Netlist(Add,unnamed_net10,CONN42-2)
Netlist(Add,unnamed_net9,CONN11-1)
Netlist(Add,unnamed_net9,R13-2)
Netlist(Add,unnamed_net8,R45-2)
Netlist(Add,unnamed_net8,U40-2)
Netlist(Add,unnamed_net7,TP9-1)
Netlist(Add,unnamed_net7,R12-2)
Netlist(Add,unnamed_net7,CONN10-1)
Netlist(Add,OUT,R12-1)
Netlist(Add,OUT,C15-2)
Netlist(Add,OUT,C10-2)
Netlist(Add,OUT,R10-2)
Netlist(Add,OUT,U10-6)
Netlist(Add,U10SUM,R11-1)
Netlist(Add,U10SUM,R13-1)
Netlist(Add,U10SUM,C15-1)
...
Netlist(Add,unnamed_net6,R41-1)
Netlist(Add,unnamed_net5,R45-1)
Netlist(Add,unnamed_net5,R41-2)
Netlist(Add,N15V,TP8-1)
Netlist(Add,N15V,C13-2)
Netlist(Add,N15V,C48-2)
Netlist(Add,N15V,C46-1)
...
Netlist(Add,unnamed_net4,L1-1)
Netlist(Add,unnamed_net4,TP4-1)
Netlist(Add,unnamed_net4,CONN40-2)
Netlist(Add,unnamed_net3,L2-1)
Netlist(Add,unnamed_net3,TP5-1)
Netlist(Add,unnamed_net3,CONN40-1)
Netlist(Add,NVIN:1,U40-4)
Netlist(Add,NVIN:1,R43-2)
Netlist(Add,NVIN:1,C41-2)
Netlist(Add,unnamed_net2,L2-2)
Netlist(Add,unnamed_net2,C41-1)
Netlist(Add,unnamed_net1,L1-2)
Netlist(Add,unnamed_net1,C40-2)
Netlist(Add,PVIN:1,R42-2)
Netlist(Add,PVIN:1,U40-1)
Netlist(Add,PVIN:1,C40-1)
Netlist(Add,SMALL,CONN41-1)
Netlist(Add,SMALL,R11-2)
...
Netlist(Thaw)
ElementList(Start)
ElementList(Need,"CONN42","connector(2, 1, spacing=100.0mil, silkmark=external)","unknown")
ElementSetAttr("CONN42","device","CONNECTOR_2")
ElementSetAttr("CONN42","manufacturer","unknown")
ElementSetAttr("CONN42","manufacturer_part_number","unknown")
ElementSetAttr("CONN42","vendor","unknown")
ElementSetAttr("CONN42","vendor_part_number","unknown")
ChangePinName("CONN42", 1, "1")
ChangePinName("CONN42", 2, "2")
ElementList(Need,"L2","AB4X2X8W-vertical.subc.lht","unknown")
ElementSetAttr("L2","device","common mode choke")
ElementSetAttr("L2","manufacturer","unknown")
ElementSetAttr("L2","manufacturer_part_number","unknown")
ElementSetAttr("L2","vendor","unknown")
ElementSetAttr("L2","vendor_part_number","unknown")
ChangePinName("L2", 1, "1")
ChangePinName("L2", 2, "2")
ElementList(Need,"L1","AB4X2X8W-vertical.subc.lht","unknown")
ElementSetAttr("L1","device","common mode choke")
ElementSetAttr("L1","manufacturer","unknown")
ElementSetAttr("L1","manufacturer_part_number","unknown")
ElementSetAttr("L1","vendor","unknown")
ElementSetAttr("L1","vendor_part_number","unknown")
...
ElementList(Need,"CONN11","connector(2, 1, spacing=100.0mil, silkmark=external)","unknown")
ElementSetAttr("CONN11","device","CONNECTOR_2")
...
ElementList(Need,"R10","0805","4.99K")
