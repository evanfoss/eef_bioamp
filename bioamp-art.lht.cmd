Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net8,R65-1)
Netlist(Add,unnamed_net8,CONN60-1)
...
Netlist(Add,unnamed_net5,R41-1)
Netlist(Add,unnamed_net4,R41-2)
Netlist(Add,unnamed_net4,U40-3)
Netlist(Add,unnamed_net3,R45-2)
Netlist(Add,unnamed_net3,U40-2)
...
Netlist(Add,unnamed_net2,CONN40-2)
...
Netlist(Add,unnamed_net1,CONN40-1)
