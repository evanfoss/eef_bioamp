Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net7,C15-1)
Netlist(Add,unnamed_net7,S10-3)
Netlist(Add,unnamed_net6,TP9-1)
Netlist(Add,unnamed_net6,R12-2)
Netlist(Add,unnamed_net6,CONN10-1)
...
Netlist(Add,unnamed_net5,J60-1)
Netlist(Add,unnamed_net5,CONN60-1)
Netlist(Add,unnamed_net5,U60-3)
...
Netlist(Add,unnamed_net3,C40-2)
Netlist(Add,PVIN:1,R43-2)
Netlist(Add,PVIN:1,C41-1)
Netlist(Add,PVIN:1,U40-3)
Netlist(Add,unnamed_net2,R41-2)
Netlist(Add,unnamed_net2,U40-8)
Netlist(Add,NVIN:1,R42-2)
Netlist(Add,NVIN:1,C40-1)
Netlist(Add,NVIN:1,U40-2)
...
ElementList(Need,"J60","0805","unknown")
ElementSetAttr("J60","device","JUMPER")
ElementSetAttr("J60","manufacturer","unknown")
ElementSetAttr("J60","manufacturer_part_number","unknown")
ElementSetAttr("J60","vendor","unknown")
ElementSetAttr("J60","vendor_part_number","unknown")
ChangePinName("J60", 1, "1")
ChangePinName("J60", 2, "2")
...
ChangePinName("C13", 2, "-")
ChangePinName("C13", 1, "+")
ElementList(Need,"C15","0805","37nF")
...
ElementList(Need,"S10","T101MHAVxx.fp","unknown")
...
ElementList(Need,"C10","0805","16nF")
...
ElementList(Need,"C62","0805","330pF")
...
ElementList(Need,"S60","T101MHAVxx.fp","unknown")
...
ElementList(Need,"C61","0805","3.3pF")
...
ElementList(Need,"C20","KEMET_SMR5xxxxxxJ06xxx.x.subc.lht","1uF")
