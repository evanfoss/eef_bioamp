Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net7,C10-1)
...
Netlist(Add,unnamed_net5,S60-3)
Netlist(Add,unnamed_net5,C61-1)
Netlist(Add,U60GAIN1:1,S60-1)
Netlist(Add,U60GAIN1:1,R63-1)
Netlist(Add,LARGER,R11-1)
Netlist(Add,LARGER,R64-2)
Netlist(Add,LARGER,C62-2)
Netlist(Add,LARGER,C61-2)
Netlist(Add,LARGER,R63-2)
Netlist(Add,LARGER,U60-6)
Netlist(Add,U60GAIN10:1,R64-1)
Netlist(Add,U60GAIN10:1,C62-1)
Netlist(Add,U60GAIN10:1,S60-2)
Netlist(Add,U60GAIN10:1,R61-2)
Netlist(Add,U60GAIN10:1,U60-2)
...
Netlist(Add,unnamed_net4,CONN40-1)
Netlist(Add,unnamed_net4,TP5-1)
Netlist(Add,unnamed_net4,C41-2)
Netlist(Add,unnamed_net3,CONN40-2)
